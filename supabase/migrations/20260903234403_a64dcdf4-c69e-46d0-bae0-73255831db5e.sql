...
REVOKE ALL ON FUNCTION public.ranking_revendedores_semanal() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.ranking_revendedores_semanal() FROM anon;
GRANT EXECUTE ON FUNCTION public.ranking_revendedores_semanal() TO authenticated;
GRANT EXECUTE ON FUNCTION public.ranking_revendedores_semanal() TO service_role;