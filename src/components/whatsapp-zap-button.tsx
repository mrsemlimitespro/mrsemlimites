...
export function WhatsappZapButton() {
  return (
    <a
      ...
      className="group fixed bottom-24 right-4 z-50 inline-flex items-center gap-2.5 rounded-full border border-white/15 bg-black/70 px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.24em] text-white backdrop-blur-xl transition-all duration-300 hover:scale-[1.03] hover:border-emerald-300/60 md:bottom-6 md:right-6 md:px-5 md:py-3 md:text-xs"
      style={{
        boxShadow:
