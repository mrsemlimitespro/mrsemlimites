...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-4" aria-hidden>
      <path fill="#EA4335" d="M12 10.2v3.9h5.5c-.24 1.4-1.7 4.1-5.5 4.1-3.3 0-6-2.7-6-6.1s2.7-6.1 6-6.1c1.9 0 3.1.8 3.8 1.5l2.6-2.5C16.9 3.4 14.7 2.4 12 2.4 6.7 2.4 2.5 6.6 2.5 12S6.7 21.6 12 21.6c6.9 0 9.5-4.8 9.5-8.4 0-.6-.1-1-.1-1.4H12z"/>
    </svg>
  );
}
function AppleIcon() {
