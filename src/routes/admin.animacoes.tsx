...
const STYLES: Style[] = [
  { id: "neon-marquee", nome: "Neon Marquee", descricao: "Esteira infinita com cards de gradiente e glow neon pulsante.", render: () => <NeonMarquee /> },
  { id: "glass-tilt", nome: "Glass Tilt", descricao: "Cards de vidro fosco com leve tilt 3D no hover.", render: () => <GlassTilt /> },
  { id: "gradient-flow", nome: "Gradient Flow", descricao: "Fundo com gradiente colorido que se move suavemente em loop.", render: () => <GradientFlow /> },
  { id: "shimmer-sweep", nome: "Shimmer Sweep", descricao: "Faixa de luz atravessando o elemento (efeito holográfico).", render: () => <ShimmerSweep /> },
  { id: "pulse-glow", nome: "Pulse Glow", descricao: "Botão/ícone com halo pulsando (chama atenção sem distrair).", render: () => <PulseGlow /> },
  { id: "float-orb", nome: "Float Orb", descricao: "Blobs coloridos flutuando lentamente no fundo (aurora).", render: () => <FloatOrb /> },
  { id: "flip-card", nome: "Flip Card", descricao: "Card gira 180° no hover, revelando o verso.", render: () => <FlipCard /> },
  { id: "reveal-up", nome: "Reveal Up", descricao: "Elemento sobe e aparece ao entrar na tela.", render: () => <RevealUp /> },
  { id: "count-up", nome: "Count Up", descricao: "Números animando de 0 até o valor final.", render: () => <CountUp /> },
  { id: "typewriter", nome: "Typewriter", descricao: "Texto digitando letra por letra com cursor piscando.", render: () => <Typewriter /> },
  { id: "aurora-hero", nome: "Aurora Hero", descricao: "Hero com auroras coloridas em movimento (topo de página).", render: () => <AuroraHero /> },
  { id: "particles-soft", nome: "Particles Soft", descricao: "Partículas leves subindo (chuva de brilho).", render: () => <ParticlesSoft /> },
  { id: "morph-blob", nome: "Morph Blob", descricao: "Blob colorido mudando de forma continuamente.", render: () => <MorphBlob /> },
  { id: "border-scan", nome: "Border Scan", descricao: "Linha de luz correndo pela borda do card.", render: () => <BorderScan /> },
  { id: "hover-scale", nome: "Hover Scale", descricao: "Card cresce e ilumina no hover — clássico e limpo.", render: () => <HoverScale /> },
  { id: "stagger-list", nome: "Stagger List", descricao: "Lista aparece item por item em cascata.", render: () => <StaggerList /> },
  { id: "gradient-text", nome: "Gradient Text", descricao: "Título com gradiente animado atravessando as letras.", render: () => <GradientText /> },
  { id: "spotlight", nome: "Spotlight", descricao: "Foco de luz seguindo o cursor sobre o card.", render: () => <Spotlight /> },
  // ===== NOVOS 20 =====
  { id: "rgb-glow", nome: "RGB Glow", descricao: "Borda arco-íris girando ao redor do card, brilho forte.", render: () => <RgbGlow /> },
  { id: "confetti-rain", nome: "Confetti Rain", descricao: "Confetes coloridos caindo continuamente.", render: () => <ConfettiRain /> },
  { id: "laser-scan", nome: "Laser Scan", descricao: "Feixe de laser vermelho varrendo a área.", render: () => <LaserScan /> },
  { id: "cyber-grid", nome: "Cyber Grid", descricao: "Grade neon estilo synthwave em perspectiva.", render: () => <CyberGrid /> },
  { id: "matrix-rain", nome: "Matrix Rain", descricao: "Chuva de caracteres verdes estilo Matrix.", render: () => <MatrixRain /> },
  { id: "fire-glow", nome: "Fire Glow", descricao: "Chamas laranjas pulsando na base.", render: () => <FireGlow /> },
  { id: "ice-shine", nome: "Ice Shine", descricao: "Cristal azul com brilho gelado atravessando.", render: () => <IceShine /> },
  { id: "rainbow-wave", nome: "Rainbow Wave", descricao: "Onda arco-íris ondulando horizontalmente.", render: () => <RainbowWave /> },
  { id: "star-burst", nome: "Star Burst", descricao: "Raios saindo do centro em explosão colorida.", render: () => <StarBurst /> },
  { id: "electric-arc", nome: "Electric Arc", descricao: "Arcos elétricos pulsando entre dois pontos.", render: () => <ElectricArc /> },
  { id: "hologram", nome: "Hologram", descricao: "Efeito holográfico com scanlines e RGB shift.", render: () => <Hologram /> },
  { id: "bubble-pop", nome: "Bubble Pop", descricao: "Bolhas coloridas subindo e estourando.", render: () => <BubblePop /> },
  { id: "neon-heart", nome: "Neon Heart", descricao: "Coração neon pulsando com batida.", render: () => <NeonHeart /> },
  { id: "disco-ball", nome: "Disco Ball", descricao: "Reflexos coloridos girando estilo discoteca.", render: () => <DiscoBall /> },
  { id: "vortex", nome: "Vortex", descricao: "Espiral colorida sugando pro centro.", render: () => <Vortex /> },
  { id: "glitch-text", nome: "Glitch Text", descricao: "Texto com glitch RGB estilo cyberpunk.", render: () => <GlitchText /> },
  { id: "neon-sign", nome: "Neon Sign", descricao: "Placa neon piscando estilo bar/motel.", render: () => <NeonSign /> },
  { id: "rainbow-orbit", nome: "Rainbow Orbit", descricao: "Bolinhas coloridas orbitando em círculo.", render: () => <RainbowOrbit /> },
  { id: "shockwave", nome: "Shockwave", descricao: "Ondas de choque expandindo continuamente.", render: () => <Shockwave /> },
  ...
  return (
    <div className="flex h-full items-center overflow-hidden">
      <div className="flex gap-3 whitespace-nowrap" style={{ animation: "marq 14s linear infinite", width: "max-content" }}>
        {track.map((it, i) => (
          <div key={i} className={`h-16 w-28 shrink-0 rounded-lg bg-gradient-to-br ${it.g}`}
            style={{
  ...
  return (
    <div className="relative h-full overflow-hidden bg-black/40">
      {Array.from({ length: 20 }).map((_, i) => (
        <div key={i} className="absolute size-1 rounded-full bg-white/80"
          style={{ left: `${(i * 47) % 100}%`, bottom: "-10px", animation: `rise ${4 + (i % 5)}s linear ${i * 0.2}s infinite` }} />
      ))}
    </div>
  );
}
...
function StaggerList() {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-1.5">
      {[0, 1, 2, 3].map((i) => (
        <div key={i} className="h-3 w-40 rounded bg-gradient-to-r from-violet-500 to-pink-500"
...
function Spotlight() {
  return (
    <div className="relative grid h-full place-items-center bg-black/50"
      onMouseMove={(e) => {
  ...
  return (
    <div className="grid h-full place-items-center">
      <div className="relative h-24 w-40 rounded-xl bg-black overflow-hidden">
        <div className="absolute -inset-1" style={{ background: "conic-gradient(from 0deg,#ff0080,#ff8c00,#ffee00,#00ff88,#00e5ff,#8a2be2,#ff0080)", animation: "spin 3s linear infinite", filter: "blur(6px)" }} />
        <div className="absolute inset-[3px] rounded-[10px] bg-black grid place-items-center text-white font-black">RGB</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative h-full overflow-hidden bg-black/60">
      {Array.from({ length: 24 }).map((_, i) => (
        <div key={i} className="absolute h-2 w-1" style={{
...
function LaserScan() {
  return (
    <div className="relative h-full overflow-hidden bg-black">
      <div className="absolute left-0 right-0 h-0.5 bg-red-500" style={{ boxShadow: "0 0 12px #ff0040, 0 0 24px #ff0040", animation: "laser 2s ease-in-out infinite" }} />
      <div className="grid h-full place-items-center text-red-400 font-mono text-xs">SCANNING...</div>
    </div>
  );
}
...
function CyberGrid() {
  return (
    <div className="relative h-full overflow-hidden" style={{ background: "linear-gradient(180deg,#0a0026 0%, #ff006e 100%)" }}>
      <div className="absolute inset-x-0 bottom-0 h-2/3" style={{
        background: "repeating-linear-gradient(90deg, transparent 0 24px, rgba(0,229,255,.7) 24px 25px), repeating-linear-gradient(0deg, transparent 0 20px, rgba(0,229,255,.7) 20px 21px)",
    ...
    <div className="relative h-full overflow-hidden bg-black font-mono text-emerald-400 text-xs">
      {Array.from({ length: cols }).map((_, i) => (
        <div key={i} className="absolute top-0" style={{
          left: `${(i / cols) * 100}%`, animation: `matrix ${2 + (i % 4)}s linear ${i * 0.2}s infinite`,
        }}>
          {Array.from({ length: 8 }).map((_, j) => (
            <div key={j} style={{ opacity: 1 - j * 0.12 }}>{String.fromCharCode(0x30a0 + ((i * 7 + j) % 96))}</div>
          ))}
        </div>
      ))}
    </div>
...
function FireGlow() {
  return (
    <div className="relative h-full overflow-hidden bg-black">
      <div className="absolute inset-x-0 bottom-0 h-2/3" style={{
        background: "radial-gradient(ellipse at 50% 100%, #ffee00 0%, #ff6600 30%, #ff0040 60%, transparent 80%)",
  ...
  return (
    <div className="grid h-full place-items-center bg-gradient-to-br from-cyan-900 to-blue-950">
      <div className="relative h-24 w-40 overflow-hidden rounded-xl bg-gradient-to-br from-cyan-300 to-blue-500 shadow-[0_0_40px_rgba(0,229,255,.6)]">
        <div className="absolute inset-y-0 -left-full w-full" style={{ background: "linear-gradient(90deg,transparent,rgba(255,255,255,.9),transparent)", animation: "sweep 2.4s linear infinite" }} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="grid h-full place-items-center overflow-hidden">
      <svg viewBox="0 0 200 60" className="w-full">
        ...
        <path d="M0 30 Q 25 5, 50 30 T 100 30 T 150 30 T 200 30" fill="none" stroke="url(#rw)" strokeWidth="4" strokeLinecap="round" style={{ filter: "drop-shadow(0 0 6px currentColor)", animation: "wave 2s linear infinite" }} />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="relative grid h-full place-items-center bg-black overflow-hidden">
      {Array.from({ length: 12 }).map((_, i) => (
        <div key={i} className="absolute h-16 w-0.5 origin-bottom"
          style={{
  ...
  return (
    <div className="relative grid h-full place-items-center bg-black overflow-hidden">
      <svg viewBox="0 0 200 100" className="w-full">
        <polyline points="10,50 40,20 70,60 100,10 130,70 160,30 190,50" fill="none" stroke="#00e5ff" strokeWidth="2" style={{ filter: "drop-shadow(0 0 6px #00e5ff)", animation: "arc .18s steps(2) infinite" }} />
      </svg>
    </div>
  );
}
...
function Hologram() {
  return (
    <div className="relative h-full overflow-hidden bg-black">
      <div className="absolute inset-0 grid place-items-center text-3xl font-black" style={{ animation: "holo 3s linear infinite" }}>HOLO</div>
      <div className="absolute inset-0 pointer-events-none" style={{ background: "repeating-linear-gradient(0deg, rgba(0,255,255,.15) 0 1px, transparent 1px 3px)", animation: "scan 4s linear infinite" }} />
    </div>
  );
}
    ...
    <div className="relative h-full overflow-hidden bg-gradient-to-b from-blue-950 to-black">
      {Array.from({ length: 10 }).map((_, i) => (
        <div key={i} className="absolute rounded-full" style={{
          left: `${(i * 41) % 90 + 5}%`, bottom: "-20px",
          width: 10 + (i % 4) * 6, height: 10 + (i % 4) * 6,
...
function NeonHeart() {
  return (
    <div className="grid h-full place-items-center bg-black">
      <div className="text-6xl" style={{ color: "#ff3ea5", textShadow: "0 0 10px #ff3ea5, 0 0 20px #ff3ea5, 0 0 40px #ff3ea5", animation: "beat 1s ease-in-out infinite" }}>♥</div>
    </div>
  );
}
  ...
  return (
    <div className="relative h-full overflow-hidden bg-black">
      <div className="absolute inset-0" style={{
        background: "conic-gradient(from 0deg, #ff3ea5, #ffee00, #00ff88, #00e5ff, #7a5cff, #ff3ea5)",
        animation: "spin 4s linear infinite", filter: "blur(30px)", opacity: .7,
      }} />
      <div className="relative grid h-full place-items-center">
        <div className="size-16 rounded-full" style={{ background: "radial-gradient(circle at 30% 30%, #fff, #888 60%, #333)", boxShadow: "0 0 40px #fff" }} />
      </div>
    </div>
  );
}
...
function GlitchText() {
  return (
    <div className="grid h-full place-items-center bg-black">
      <div className="relative text-3xl font-black text-white glitch" data-text="GLITCH">GLITCH</div>
    </div>
  );
}
  ...
  return (
    <div className="relative grid h-full place-items-center bg-black">
      <div className="relative size-24" style={{ animation: "spin 3s linear infinite" }}>
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="absolute size-4 rounded-full" style={{
            top: "50%", left: "50%",
...
function Shockwave() {
  return (
    <div className="relative grid h-full place-items-center bg-black overflow-hidden">
      {[0, 1, 2].map((i) => (
        <div key={i} className="absolute rounded-full border-2 border-fuchsia-400"
          style={{ animation: `shock 2s ease-out ${i * 0.6}s infinite`, boxShadow: "0 0 20px #ff3ea5" }} />
      ))}
...
function CandyStripes() {
  return (
    <div className="h-full w-full" style={{
      background: "repeating-linear-gradient(45deg, #ff3ea5 0 20px, #ffee00 20px 40px, #00e5ff 40px 60px, #7a5cff 60px 80px)",
